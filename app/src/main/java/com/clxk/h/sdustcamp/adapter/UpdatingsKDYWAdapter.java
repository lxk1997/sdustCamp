 ...
 * 动态-科大要问适配器
 */
public class UpdatingsKDYWAdapter extends BaseQuickAdapter<Updatings, BaseViewHolder> {


    public UpdatingsKDYWAdapter(int layoutResId, @Nullable List<Updatings> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder viewHolder, Updatings item) {

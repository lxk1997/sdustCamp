...
public class MarketNewsFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        currentView = inflater.inflate(R.layout.fragment_market_news,container,false);
